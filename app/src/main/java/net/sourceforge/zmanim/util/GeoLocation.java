 ...
 * specific implementations of the {@link net.sourceforge.zmanim.util.AstronomicalCalculator} to see if elevation is calculated as part of the
 * algorithm.
 * 
...
public class GeoLocation implements Cloneable {
	 ...
	 * {@link java.util.Calendar#setTimeZone(java.util.TimeZone) setTimeZone(TimeZone)} is called after cloning in order for the
