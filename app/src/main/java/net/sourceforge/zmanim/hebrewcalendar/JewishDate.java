...
public class JewishDate implements Comparable<JewishDate>, Cloneable {
	 ...
	 * @see net.sourceforge.zmanim.hebrewcalendar.HebrewDateFormatter#getFormattedKviah(int)
	 */
	 ...
	 *            constants such as {@link net.sourceforge.zmanim.hebrewcalendar.JewishDate#TISHREI}.
	...
	/**
	 * Converts the the {@link net.sourceforge.zmanim.hebrewcalendar.JewishDate#NISSAN} based constants used by this class to numeric month starting from
	 * {@link net.sourceforge.zmanim.hebrewcalendar.JewishDate#TISHREI}. This is required for Molad claculations.
	 * 
	 * @param year
	 *            The Jewish year
	 * @param month
	 ...
	 *            {@link java.util.GregorianCalendar}, where {@link java.util.Calendar#JANUARY} has a value of 0.
	 * @param dayOfMonth
	 ...
	 *            a leap year, 13 will be the expected value for Adar II. Use the constants {@link net.sourceforge.zmanim.hebrewcalendar.JewishDate#NISSAN}
	 *            etc.
	 * @param dayOfMonth
	 ...
	 * @throws IllegalArgumentException
	 *             if the {@link java.util.Calendar#ERA} is {@link java.util.GregorianCalendar#BC}
	 */
	 ...
	 * @see net.sourceforge.zmanim.hebrewcalendar.HebrewDateFormatter#format(net.sourceforge.zmanim.hebrewcalendar.JewishDate)
	 */
	 ...
	 * manipulation is required use the {@link java.util.Calendar} class {@link java.util.Calendar#add(int, int)} or
