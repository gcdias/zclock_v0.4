...
public class ZmanimCalculator extends AstronomicalCalculator {
	...
	/**
	 * @see AstronomicalCalculator#getUTCSunrise(java.util.Calendar, net.sourceforge.zmanim.util.GeoLocation, double, boolean)
	 */
	...
	/**
	 * @see AstronomicalCalculator#getUTCSunset(java.util.Calendar, net.sourceforge.zmanim.util.GeoLocation, double, boolean)
	 */
