 ...
 * to a different implementation by implementing the abstract {@link net.sourceforge.zmanim.util.AstronomicalCalculator} and setting it with the
 * {@link #setAstronomicalCalculator(net.sourceforge.zmanim.util.AstronomicalCalculator)}. A number of different calculation engine implementations
...
public class AstronomicalCalendar implements Cloneable {
	 ...
	 * <b>Note </b>: it is important to note that for sunrise and sunset the {@link net.sourceforge.zmanim.util.AstronomicalCalculator#adjustZenith
	 ...
	 * {@link net.sourceforge.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double) elevation adjusted} sunrise time. The zenith used
	 * for the calculation uses {@link #GEOMETRIC_ZENITH geometric zenith} of 90&deg; plus
	 * {@link net.sourceforge.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double)}. This is adjusted by the
	 * {@link net.sourceforge.zmanim.util.AstronomicalCalculator} to add approximately 50/60 of a degree to account for 34 archminutes of refraction
	 * and 16 archminutes for the sun's radius for a total of {@link net.sourceforge.zmanim.util.AstronomicalCalculator#adjustZenith 90.83333&deg;}.
	 * See documentation for the specific implementation of the {@link net.sourceforge.zmanim.util.AstronomicalCalculator} that you are using.
	 * 
	 ...
	 * @see net.sourceforge.zmanim.util.AstronomicalCalculator#adjustZenith
	...
	/**
	 * A method that returns the sunrise without {@link net.sourceforge.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double) elevation
	 ...
	 * {@link net.sourceforge.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double) elevation adjusted} sunset time. The zenith used for
	 * the calculation uses {@link #GEOMETRIC_ZENITH geometric zenith} of 90&deg; plus
	 * {@link net.sourceforge.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double)}. This is adjusted by the
	 * {@link net.sourceforge.zmanim.util.AstronomicalCalculator} to add approximately 50/60 of a degree to account for 34 archminutes of refraction
	 * and 16 archminutes for the sun's radius for a total of {@link net.sourceforge.zmanim.util.AstronomicalCalculator#adjustZenith 90.83333&deg;}.
	 * See documentation for the specific implementation of the {@link net.sourceforge.zmanim.util.AstronomicalCalculator} that you are using. Note:
	...
	/**
	 * A method that returns the sunset without {@link net.sourceforge.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double) elevation
	 * adjustment}. Non-sunrise and sunset calculations such as dawn and dusk, depend on the amount of visible light,
	 ...
	 * offset as a <code>long</code> and calls {@link #getTimeOffset(java.util.Date, long)}.
	 * 
	 * @param time
	 *            the start time
	 * @param offset
	...
	/**
	 * Default constructor will set a default {@link net.sourceforge.zmanim.util.GeoLocation#GeoLocation()}, a default
	 * {@link net.sourceforge.zmanim.util.AstronomicalCalculator#getDefault() AstronomicalCalculator} and default the calendar to the current date.
	 */
	...
	/**
	 * A method that returns an {@link net.sourceforge.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double) elevation adjusted}
	 ...
	 * @see #getSunrise()
	 * @see #getSunset()
	 * @see #getTemporalHour(java.util.Date, java.util.Date)
	 * 
	 ...
	 * @see #getSunTransit(java.util.Date, java.util.Date)
	 * @see #getTemporalHour()
	 */
	...
	/**
	 * A method that returns the currently set {@link net.sourceforge.zmanim.util.GeoLocation} which contains location information used for the
	...
	/**
	 * Sets the {@link net.sourceforge.zmanim.util.GeoLocation} <code>Object</code> to be used for astronomical calculations.
	 * 
	 * @param geoLocation
	 ...
	 * @see #setAstronomicalCalculator(net.sourceforge.zmanim.util.AstronomicalCalculator)
	 */
	...
	/**
	 * A method to set the {@link net.sourceforge.zmanim.util.AstronomicalCalculator} used for astronomical calculations. The Zmanim package ships
	 * with a number of different implementations of the <code>abstract</code> {@link net.sourceforge.zmanim.util.AstronomicalCalculator} based on
	 ...
	 * {@link java.util.Calendar#setTimeZone(java.util.TimeZone) setTimeZone(TimeZone)} be called in order for the
