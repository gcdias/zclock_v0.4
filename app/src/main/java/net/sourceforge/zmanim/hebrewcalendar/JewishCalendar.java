...
public class JewishCalendar extends JewishDate {
	 ...
	 * {@link net.sourceforge.zmanim.hebrewcalendar.HebrewDateFormatter#formatParsha(net.sourceforge.zmanim.hebrewcalendar.JewishCalendar)}.
	 * 
	 ...
	 * {@link net.sourceforge.zmanim.hebrewcalendar.HebrewDateFormatter#formatDafYomiBavli(net.sourceforge.zmanim.hebrewcalendar.Daf)} for the ability to format the daf in Hebrew or transliterated
	 * masechta names.
	 * 
	 * @return the daf as a {@link net.sourceforge.zmanim.hebrewcalendar.Daf}
	 */
