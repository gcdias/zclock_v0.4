...
public class YomiCalculator {
	 ...
	 * href="http://en.wikipedia.org/wiki/Talmud">Bavli</a> {@link net.sourceforge.zmanim.hebrewcalendar.Daf} for a given date. The first Daf Yomi cycle
	 ...
	 * @return the {@link net.sourceforge.zmanim.hebrewcalendar.Daf}.
	 * 
