 ...
 * on using the API. <br/>
 * <b>Note:</b> It is important to read the technical notes on top of the {@link net.sourceforge.zmanim.util.AstronomicalCalculator} documentation.
...
public class ZmanimCalendar extends AstronomicalCalendar {
	 ...
	 * level sunrise}.
	 * 
	 * @see #getSofZmanShma(java.util.Date, java.util.Date)
	 ...
	 * of non-sea level sunset, pass the elevation adjusted sunset to {@link #getTimeOffset(java.util.Date, long)}.
	 * 
	 ...
	 * 
	 * @see #getSofZmanTfila(java.util.Date, java.util.Date)
	 * @see #getShaahZmanisGra()
	 ...
	 * 
	 * @see #getMinchaGedola(java.util.Date, java.util.Date)
	 * @see #getShaahZmanisGra()
	 * @see #getMinchaKetana()
	 ...
	 * 
	 * @see #getMinchaKetana(java.util.Date, java.util.Date)
	 * @see #getShaahZmanisGra()
	 * @see #getMinchaGedola()
	 ...
	 * {@link #getSeaLevelSunrise() sea level sunrise}.
	 * 
	 * @see #getPlagHamincha(java.util.Date, java.util.Date)
	...
	/**
	 * A method that returns a <em>shaah zmanis</em> ( {@link #getTemporalHour(java.util.Date, java.util.Date) temporal hour}) according to
	...
	/**
	 * A constructor that takes a {@link net.sourceforge.zmanim.util.GeoLocation} as a parameter.
	 * 
	 * @param location
	 *            the location
	 */
