...
public class ComplexZmanimCalendar extends ZmanimCalendar {
	 ...
	 * @see net.sourceforge.zmanim.util.GeoLocation#getLocalMeanTimeOffset()
	 */
	 ...
	 * may change or be removed in the future since it depends on the still changing {@link net.sourceforge.zmanim.hebrewcalendar.JewishCalendar} and related
	 * classes.
	 * 
	 * @param alos
	 ...
	 * @see #getSofZmanKidushLevana15Days(java.util.Date, java.util.Date)
	 */
	 ...
	 * {@link net.sourceforge.zmanim.hebrewcalendar.JewishCalendar} and related classes.
	 * 
	 * @return the Date representing the moment halfway between molad and molad. If the time occurs between
	 *         <em>alos</em> and <em>tzais</em>, <em>alos</em> will be returned
	 * @see #getSofZmanKidushLevanaBetweenMoldos(java.util.Date, java.util.Date)
	 ...
	 * {@link #getSofZmanKidushLevanaBetweenMoldos(java.util.Date, java.util.Date) half way between molad and mold} is of the opinion that
	 ...
	 * the future since it depends on the still changing {@link net.sourceforge.zmanim.hebrewcalendar.JewishCalendar} and related classes.
	 * 
	 * @param alos
	 *            the begining of the Jewish day
	 * @param tzais
	 ...
	 * removed in the future since it depends on the still changing {@link net.sourceforge.zmanim.hebrewcalendar.JewishCalendar} and related classes.
	 * 
	 ...
	 * @see #getTchilasZmanKidushLevana7Days(java.util.Date, java.util.Date)
	 */
	 ...
	 * @return the Date representing the moment 3 days after the molad. If the time occurs between <em>alos</em> and
	 *         <em>tzais</em>, <em>tzais</em> will be returned
	 * @see #getTchilasZmanKidushLevana3Days(java.util.Date, java.util.Date)
