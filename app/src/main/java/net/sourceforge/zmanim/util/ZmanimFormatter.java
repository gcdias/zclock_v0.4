...
public class ZmanimFormatter {
	...
	/**
	 * constructor that defaults to this will use the format "h:mm:ss" for dates and 00.00.00.0 for {@link net.sourceforge.zmanim.util.Time}.
	 */
	...
	/**
	 * A method that formats {@link net.sourceforge.zmanim.util.Time}objects.
	 * 
	 * @param time
